...
export default function FloatingBar() {
  ...
  return (
    <nav className="fixed bottom-8 left-1/2 -translate-x-1/2 z-50">
      {/* 1. div className을 한 줄로 수정 */}
      <div className="flex items-center justify-between w-[184px] h-[56px] p-2 gap-2 bg-white rounded-full shadow-[0_0_16px_rgba(232,232,232,0.3),0_0_8px_rgba(56,57,56,0.2)]">
        {navItems.map((item) => {
