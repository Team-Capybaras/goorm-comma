...
public class ParkController {
    ...
    public ApiResponse<GetParksResponse> getParks(
            @Parameter(
        ...
        GetParksResponse response = parkService.getParks(cursor, size);
    ...
    public ApiResponse<GetAllParksResponse> getAllParks() {
